package com.akshay.messenger.server;
...
import com.akshay.messenger.model.Contact;
import com.akshay.messenger.model.EMFService;
import com.akshay.messenger.model.Group;
...
public class ChatServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		// logger.log(Level.WARNING, "ChatServlet: msg=" +
		// msg+", from="+from+", to="+to);
		...
		// .delayWhileIdle(true)
				.addData(Constants.TO, to).addData(Constants.FROM, from).addData(Constants.MSG, msg).build();
